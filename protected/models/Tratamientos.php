 ...
 */
class Tratamientos extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_consulta, id_medicamento', 'required'),
			array('id_consulta, id_medicamento', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_consulta, id_medicamento', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Tratamientos the static model class
	 */
